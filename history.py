...
historical_recommendations = [
    ...
    ("assets/acropolis.png", "Acropolis of Athens", "Discover the architectural wonders of ancient Greece."),
...
for idx, site_info in enumerate(historical_recommendations):
    ...
    explore_button = ttk.Button(card_frame, text="Explore", command=lambda site_name=site_name: explore_place(site_name))
